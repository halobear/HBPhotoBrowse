...
- (void)hideGrid {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        [self setControlsHidden:YES animated:YES permanent:NO]; // retrigger timer
    }];
...
- (void)showControls { [self setControlsHidden:YES animated:YES permanent:NO]; }
